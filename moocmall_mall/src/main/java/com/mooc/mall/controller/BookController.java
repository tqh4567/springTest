...
import com.mooc.mall.service.BookService;
...
public class BookController {
	...
	public Result findById(@PathVariable String id){
		return new Result(true,StatusCode.OK,"查询成功",bookService.findById(id));
	}
	...
	public Result update(@RequestBody Book book, @PathVariable Long id ){
		book.setId(id);
